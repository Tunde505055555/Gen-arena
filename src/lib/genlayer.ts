 ...
 */
export const ARENA_ADDRESS = "0x7326981188F036953Be07C63AF482B022706ccE6" as const;
...
export type Submission = {
  ...
  reasoning: string;
  sources: string;
  /** URLs parsed and fetched in-contract during judging. */
  urls?: string[];
};
...
export type Battle = {
  ...
  judgement: Judgement;
  appeal: Appeal;
  /** True once Elo ratings have been applied for this battle. */
  rated?: boolean;
  rated_winner?: string;
};
